          ...
          <div class="col-xs-12 col-sm-9 col-md-9 content">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-6">  
                ...
                <label>Relationship Status:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['status_id'], "status");?></p></div>
                <label>Looking for a:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['seeking_id'], "seeking");?></p></div>                
                <label>Birth Date:</label><div class="output-box-normal"><p><p><?php echo $_SESSION['birth_date']; ?></p></div>                
                <label>Hair Colour:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['hair_id'], "hair");?></p></div>
                <label>Body Type:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['body_id'], "bodies");?></p></div>
                <label>Smoker:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['smoker_id'], "smoker");?></p></div>                                
                <label>Ethnicity:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['ethnic_id'], "ethnicity");?></p></div>
                <label>Spoken Language:</label><div class="output-box-normal"><p><p><?php echo getProperty($_SESSION['user_id'], $_SESSION['language_id'], "languages");?></p></div>
              </div>
              <div class="col-sm-6 col-md-6">
